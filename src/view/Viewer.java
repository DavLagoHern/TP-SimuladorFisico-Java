...
public class Viewer extends JComponent implements SimulatorObserver {
	...
	protected void paintComponent(Graphics g) {
		...
		gr.setColor(Color.red); //color
		gr.setStroke(new BasicStroke(1.5f)); //grosor en float
		...
		if (_showHelp) {
			...
			gr.drawString("h: toggle help, v: toggle vector, +: zoom_in, -: zoom_out, =: fit", 15, 30);
			gr.drawString("Scaling Ratio: " + _scale, 15, 45);
		}
	}
